        ...
        <h5 class="card-title text-uppercase">TAMBAH DATA</h5><hr />
            ...
            <form method="POST" action="{{ route('prov.store') }}" class="form-horizontal form-material m-t-40 needs-validation" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="kodeprov" type="text" class="form-control @error('kodeprov') is-invalid @enderror" name="kodeprov" value="{{ old('kodeprov') }}" maxlength="100" required autocomplete="kodeprov" autofocus>
